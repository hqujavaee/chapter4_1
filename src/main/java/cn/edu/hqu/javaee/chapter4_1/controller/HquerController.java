package cn.edu.hqu.javaee.chapter4_1.controller;
...
import cn.edu.hqu.javaee.chapter4_1.Chapter41Application;
import cn.edu.hqu.javaee.chapter4_1.controller.formEntity.LoginForm;
import cn.edu.hqu.javaee.chapter4_1.controller.formEntity.RegisterForm;
import cn.edu.hqu.javaee.chapter4_1.entity.Hquer;
import cn.edu.hqu.javaee.chapter4_1.service.HquerService;
		...
		if (errors.hasErrors())
			...
			if (!hquerService.register(hquer)) {
				...
				Files.copy(registerForm.getPicFile().getInputStream(),
						Paths.get(Chapter41Application.ROOT, hquer.getUserName() + ".jpeg"),
